...
class BiblesTest extends TestCase {
    ...
    public function setUp(): void {
        ...
        $this->biblesResource = new Bibles($this->client);
    }
    ...
    public function testAll() {
        ...
        $this->assertInstanceOf(BibleSummaryCollection::class, $this->biblesResource->all());
    }
    ...
    public function testGet() {
        ...
        $this->client->expects($this->once())
                     ->method('request')
                     ->with('https://api.scripture.api.bible/v1/bibles/22')
                     ->willReturn($response);

        $this->assertInstanceOf(Bible::class, $this->biblesResource->get('22'));
    }
}
